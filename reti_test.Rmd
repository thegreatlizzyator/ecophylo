...
eco$timeframes(I=as.integer(3), T=2, a=0.3)
sim1 <- eco$simulate(as.integer(100), as.integer(1e4), as.integer(1e-3))
sim1
```
...
```{r, eval=FALSE}
# NOT RUN
eco$dosimuls(nsim = 5, sample_size = 100, comprior = list(1000,10e9),
             muprior = list(1e-6) , verbose = TRUE, seed = 42)
```

```{python, eval=FALSE}
# NOT RUN
eco.dosimuls(nsim = 5, sample_size = 100, comprior = [1000,10e9], 
             muprior = [1e-6] , verbose = True, seed = 42)
```
