...
changetime <- list(list(0,100)) # the time (in generations) at which metacommunity size has changed

n <- list(as.integer(10)) # the sample size
Jm <- list(list(as.integer(500),as.integer(1000))) # the size of the metacommunity (sensu Hubbell, 2001)
mu <- as.numeric(0.01) # the point mutation rate
